...
function operateLoad() {
    var html = "";
    xy.doAjaxRequest(prefix + '/operate', {}, {
        type: "get"
    }).done(function (resp) {
        var data = resp.data;
        ...
        $("#searchOperation").append(html);
        $("#searchOperation").trigger('chosen:updated');
    });
}
    ...
    $('#exampleTable').bootstrapTable({
        ...
        queryParams: function (params) {
            if ($('#searchOperation').val() !== '') {
                params.operation = $('#searchOperation').val();
            }
