...
function selectLoad() {
    ...
    xy.doAjaxRequest(prefix + '/type', {}, {
        ...
        $('.chosen-select').on('change', function (e, params) {
            var opt = {query: {}};
            if (params.selected !== '') {
                opt.query.type = params.selected;
            }
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    if (s_add_h) {
                        f = '<a class="btn btn-success btn-sm ' + s_add_h + '" href="#" title="增加"  mce_href="#" onclick="addD(\''
...
function reLoad() {
    var opt = {query: {}};
    if ($.trim($('.chosen-select').val()) !== '') {
        opt.query.type = $.trim($('.chosen-select').val());
    }
    $('#exampleTable').bootstrapTable('refresh', opt);
}
